...
---@field public get_cache_objects_list_raw fun(self: unit_manager, only_basic: boolean): table
---@field public get_cache_object_list fun(self: unit_manager, only_basic: boolean): table
