-- Aspect of the Turtle (ID: 186265)
-- Major defensive; immunity and damage reduction
return function(engine)
  engine:register_spell({
    ...
    is_usable = function(ctx)
      ...
      if ctx.can_cast and not ctx.can_cast(186265) then return false end
      return true
    end,
    ...
    execute = function(ctx)
      if ctx.cast_spell then return ctx.cast_spell(186265) end
      return false
    end,
  })
end
